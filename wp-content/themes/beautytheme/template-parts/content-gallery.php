<article id="post-<?php the_ID(); ?>" <?php post_class( 'beauty-format-gallery' ); ?>>
	<header class="entry-header text-center">

		<?php if( beauty_get_attachment() ):
			$attachments = beauty_get_attachment(7);
			...
			<div id="post-gallery-<?php the_ID(); ?>" class="carousel slide sunset-carousel-thumb" data-ride="carousel">
				...
				<div class="carousel-inner" role="listbox">
					...
					$attachments = beauty_get_bs_slides( beauty_get_attachment(7) );
